...
function choiseCase(clicked_id) {
    ...
    if (clicked % 2 == 0) {
        ...
        findElement(player);
        finished();
        $('.player-turn').css({ "border-bottom": "none" }) $('.cpu-turn').css({ "border-bottom": "3px solid #e29126" }) $('#' + clicked_id).prop("disabled", true);
...
function computer() {
    ...
    $('.cpu-turn').css({ "border-bottom": "3px solid  #4286f4" })
